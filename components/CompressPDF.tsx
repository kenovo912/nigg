...
const CompressPDF: React.FC = () => {
  ...
  const handleCompress = useCallback(() => {
    ...
    const conversionTimeout = setTimeout(() => {
      ...
      const prepareTimeout = setTimeout(() => {
        ...
        // Simulate compression by just creating a blob of the original file
  ...
  const getOutputFilename = () => {
    ...
    return `${nameWithoutExtension}-compressed.pdf`;
  };

  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white">PDF Compressor</h2>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg transition-shadow duration-300">
        {!file && (
          ...
          >
            ...
            <input type="file" ref={fileInputRef} onChange={(e) => handleFileSelect(e.target.files ? e.target.files[0] : null)} className="hidden" accept=".pdf,application/pdf" />
          </div>
        )}
