  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white">Save Website as PDF</h2>
        <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
          Enter a URL to capture a webpage and save it as a PDF document.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
        ...
        <div className="mt-4 flex flex-wrap gap-2 justify-center">
          <button onClick={handleCapture} disabled={isLoading || !url.trim() || !!downloadUrl || isPreparing} className="px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center min-w-[160px]">
            {isLoading ? <Loader /> : 'Capture & Convert'}
          </button>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg min-h-[100px]">
            ...
            {downloadUrl && (
              <div className="text-center">
                ...
                <a href={downloadUrl} download="website.pdf" className="inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700">
