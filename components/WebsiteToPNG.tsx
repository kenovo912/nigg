  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white">Website PNG Screenshot</h2>
        <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
          Enter a URL to capture a webpage and save it as a PNG image.
        </p>
      </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg min-h-[100px]">
            ...
            {downloadUrl && (
              <div className="text-center">
                ...
                <a href={downloadUrl} download="website-screenshot.png" className="inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700">
