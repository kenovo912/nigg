  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white">PDF OCR</h2>
        <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
          Extract text from your scanned PDFs and images.
        </p>
      </div>
             ...
             {inlineError ? (
                ...
                <>
                    <p className="mt-4 text-center text-gray-600 dark:text-gray-400">
                      <span className="font-semibold text-indigo-600 dark:text-indigo-400">Click to upload</span> or drag and drop a PDF file
                    </p>
                    <p className="text-sm text-gray-500 dark:text-gray-500">Supported: .pdf</p>
                </>
            )}
            <input type="file" ref={fileInputRef} onChange={(e) => handleFileSelect(e.target.files ? e.target.files[0] : null)} className="hidden" accept="application/pdf" />
          </div>
        )}
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg min-h-[100px]">
            {isLoading && (
              <div className="flex flex-col items-center">
                <p className="text-center text-gray-600 dark:text-gray-400 mb-2">Recognizing text... {Math.round(progress)}%</p>
            ...
            {downloadUrl && (
              <div className="text-center">
                <p className="text-lg font-semibold text-green-600 dark:text-green-400 mb-4">Text Extracted Successfully!</p>
